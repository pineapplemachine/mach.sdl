...
struct Color {
    ...
    Values values = Aliases!(Value(0), Value(0), Value(0), Value(0));
    alias values this;
    
    alias red = typeof(this).values[0];
    alias green = typeof(this).values[1];
    alias blue = typeof(this).values[2];
    alias alpha = typeof(this).values[3];
    alias r = typeof(this).red;
    alias g = typeof(this).green;
    alias b = typeof(this).blue;
    alias a = typeof(this).alpha;
    ...
    auto clamp() const{
        return typeof(this)(
            this.r < 0.0 ? 0.0 : (this.r > 1.0 ? 1.0 : this.r),
            this.g < 0.0 ? 0.0 : (this.g > 1.0 ? 1.0 : this.g),
            this.b < 0.0 ? 0.0 : (this.b > 1.0 ? 1.0 : this.b),
            this.a < 0.0 ? 0.0 : (this.a > 1.0 ? 1.0 : this.a),
        );
    }
